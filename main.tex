...
A system simulation also called a simulation unit (SU), is typically given by an executable binary conforming to a predefined interface.
...
% TODO optional: Example of a periodic master algorithm
