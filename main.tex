...
Typically, a coordination approaches is focused on one of the two mechanisms but both can be supported.
...
However, data-exchange might also happen between components during synchronization of events, which is why both coordination mechanisms can be supported simultaneously.
