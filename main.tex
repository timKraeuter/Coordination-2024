...
Second, coordination approaches in the \textit{continuous time} domain, support components to have state that evolves continuously over time.
...
Third, the \textit{hybrid} domain is a mix of the first two domains that occurs in co-simulation of cyber-physical-systems.
...
To strategies are known to deal with hybrid systems, one either adapts the components from the continuous time to the discrete event domain or vice versa \cite{gomesCoSimulationSurvey2019}.
