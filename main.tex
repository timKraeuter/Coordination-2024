...
The aim is to compare coordination approaches from different categories by first identifying the coordination \textit{foundation}: coordination mechanism, syntax, semantics, and degree of formality.
