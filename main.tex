...
% Move most of the running example implementation out, I think.
\subsection{Co-Simulation: DACCOSIM} % Co-Simulation representative
\subsection{Coordination Language: Lingua Franca/Linda} % Coordination language representative

\subsection{ADL: MontiArc} \label{subsec:montiArc}
We classify MontiArc using our feature model.


\subsection{Coordination framework: BCoorLang}
We classify BCoorLang using our feature model.
...
% Maybe they can somehow be visualized nicely using some clusters with overlaps (Venn diagram in Python or even upset plots)
