...
% Coordination language
\textbf{Coordination languages} can have simulation and execution as their goal.
...
% primarily data-exchange between black-box components in a hybrid domain. --> mention domain in the other texts.
% also architecture-based --> Seems very much universally accepted
% also some are federated 
% some offer heterogeneous components by wrapping. shoutout mecsyco
