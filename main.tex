...
% Are there really approaches that are binary or is behavior different from structure?
\subsubsection{Arity} A coordination approach can either support the coordination of exactly two components (\textit{binary}) or two and more components (\textit{multi-ary}).
