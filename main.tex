...
\textit{A coordination language} provides a language and infrastructure to communicate and synchronize between components potentially executing on different machines.
...
The operations in Linda are used to read from and write to a shared tuple space, which serves as a \textit{global} communication medium.
...
To encode reactions, the user can choose an existing programming language, such as C, C\textsf{++}, Python, TypeScript, and Rust.
