...
The clustering algorithm finds three clusters using the distances between the approaches containing all but one approach.
\textit{Cluster 0} contains BCoorLang and BCOol, coordination frameworks with similar features.
\textit{Cluster 1} consists of a mix of coordination languages and ADLs, such as Linda and Lingua Franca, as well as Wright and MontiArc, respectively.
\textit{Cluster 2} includes three co-simulation approaches, while no cluster contains Ptolemy.
