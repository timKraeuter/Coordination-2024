...
The goal of the feature model is to compare coordination approaches from different categories.
...
Thus, it is more coarse-grained and not necessarily suitable to compare approaches from the same category.
For example, if one only wants to compare co-simulation approaches the feature model might not distinguish them enough since it can be missing the necessary level of detail.
...
For example, how can coordination be specified and what is its semantic, what are the goals of a coordination approach, how the coordination is implemented, and for system domains is it suitable. 

The feature model for coordination approaches is shown in \autoref{fig:featureModelOverview}.
