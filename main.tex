...
The feature model for coordination approaches is shown in \autoref{fig:featureModelRoot} where each coordination approach has three main feature sets: \textit{Coordination}, \textit{Goal}, and \textit{Properties}.

\begin{figure}[ht]
	\centering
	\includegraphics[width=1\textwidth]{images/root}
	\caption{Feature model root}
	\label{fig:featureModelRoot}
\end{figure}
...
A diagram of the feature model, including all features, is contained in \cite{anonymousauthorsCoordination2024Artifacts2024}.
