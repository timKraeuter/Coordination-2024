...
% TODO: Add full feature model as an artifact (at the end when the feature model is stable).
...
% TODO: Remove name in the artifacts!
...
% TODO: Add executable GT with tutorial to the artifacts. Maybe also Maude one.
