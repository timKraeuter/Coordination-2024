...
% Motivation: Coordination is everywhere and is super important since a single system cannot handle the complexity of todays world.
Systems are becoming more and more complex due to increasing performance and reliability requirements, present and changing regulations, the integration of AI models and many other factors.
...
However, coordination of heterogeneous components comes with its own challenges and pitfalls.
