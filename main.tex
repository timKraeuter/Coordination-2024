...
Each approach represents a co-simulation tool (\textit{DACCOSIM}), coordination language (\textit{Linda} \cite{carrieroLindaContext1989,carrieroLindaAlternativeMessagepassing1994}), ADL (\textit{MontiArc}\cite{}), or coordination framework (\textit{BCoorLang}).
% We did we choose these?
...
\begin{table}
	...
	\begin{tblr}{
		...
		\hspace{2mm} Implementation & PL & PL & PL & Formal language \\
	\end{tblr}
	}
\end{table}
