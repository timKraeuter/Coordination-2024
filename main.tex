...
\autoref{lst:MontiArc-Crossing} show the components of the pedestrian crossing running example in MontiArc.
% TODO: Describe the example code and refer to components, connectors, and architectural configuration.
...
% TODO: Artifacts
The executable source of our MontiArc implementation for the running example can be found in \cite{krauterCoordination2024Artifacts2024}.
