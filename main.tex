...
This structure is used to determine if the combined semantics results in the desired behavior.
...
For this paper, we consider only ADLs which incorporate a formal semantics and thus do not consider other modeling languages such as UML and Archimate which can be seen as ADLs.
