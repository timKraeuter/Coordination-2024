...
Components can be homogeneous or heterogeneous by wrapping them in specific formalisms such as DEVS in the case of MECSYCO. % TODO: Cite
Typically, execution is federated, while some approaches, such as DACCOSIM, even allow for a distributed execution.  % TODO: Cite

% Coordination frameworks
\textbf{Coordination frameworks}

% Any outliers?
% What are the unique features of each approach? Does this match their intended usage scenarios?
% Somehow enter a general discussion with the approaches below:

% Generally, choosing a coordination approach depends on the nature of the system at hand.
...
\textbf{Coordination frameworks do not support Data-Exchange:} All coordination frameworks besides Ptolemy support \textsf{Event-Scheduling} but not \textsf{Data-Exchange} as a coordination mechanism.
...
Also, data exchange is identified as an important future work in BCOol~\cite{krauterBehavioralConsistencyMultimodeling2023,varalarsenBCOolBehavioralCoordination2016}.
