...
\autoref{fig:overviewRunningExample} depicts the \textit{pedestrian crossing} running example.
...
Thus, the car and pedestrian TLs cannot act independently.
They must coordinate their state changes.
In addition, either the car or the pedestrian TLs, but not both, must be green to ensure \textit{progress in traffic} flow.
