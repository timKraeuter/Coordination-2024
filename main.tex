...
\autoref{tab:classification} shows the classification of the four approaches.
...
\begin{table}
	...
	\begin{tblr}{
		...
		\diagbox[linewidth=1.1pt, width=4.4cm,font=\bfseries]{Feature}{Approach} & BCoorLang & MontiArc & Linda & DACCOSIM \\
		
		\textbf{Coordination} \\
		\hspace{2mm} Definition & Dedicated elements & Architecture based & Name based & Name based \\
		...
		\hspace{2mm} MoC & Logical Time & Logical Time, Causal & Causal & Causal \\
...
The raw data, including all other classifications, are available in \cite{timkrauterArtifactsCoordination2024}.
