...
In addition, the car or the pedestrian TLs must be green to ensure \textit{progress in traffic} flow.
...
We further analyze the classification of the 16 approaches to find out how approaches compare across and inside the four different categories.
