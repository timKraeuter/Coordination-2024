...
Moreover, we apply the taxonomy to evaluate 17 distinct approaches spanning the aforementioned categories (\autoref{sec: application}) and publish our findings in a public dataset~\cite{timkrauterCoordination2024Artifacts2024}.
...
Our exact search queries are given in~\cite{timkrauterCoordination2024Artifacts2024}.
...
Due to space constraints, we cannot show all classifications, but they are available in the artifacts~\cite{timkrauterCoordination2024Artifacts2024}.
...
However, one can adapt the analysis using the provided data and scripts~\cite{timkrauterCoordination2024Artifacts2024}.
...
The data and scripts to reproduce our analysis are available in~\cite{timkrauterCoordination2024Artifacts2024}.
...
Furthermore, we apply our taxonomy to 17 coordination approaches and publish the results as open data~\cite{timkrauterCoordination2024Artifacts2024}.
% Findings
