...
We used Google Scholar to locate these papers, utilizing the keywords "survey," "feature model," "taxonomy," and for each category, "coordination language," "architecture description language," or "co-simulation" accordingly.
We state the exact search queries used in \cite{timkrauterArtifactsCoordination2024}.
