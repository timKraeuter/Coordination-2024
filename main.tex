...
\lstdefinelanguage{MontiArc}[]{Java}{
	keywords = {},
	morekeywords = {PedestrianCrossing, CarTL, PedestrianTL, Signal},
	commentstyle=\color{DarkGreen},
	emph={
		component, port, automaton, sync, initial, state
	},
	emphstyle={\color{blue}\bfseries},
	numbers=left,
	numberstyle=\tiny\color{black},
...
\autoref{lst:MontiArc-Crossing} show the implementation of the pedestrian crossing running example in MontiArc.
% TODO: Describe the example code and refer to components, connectors, and architectural configuration.

% TODO: Highlight keywords such as component, port, and automaton. Maybe even more.
\lstinputlisting[
