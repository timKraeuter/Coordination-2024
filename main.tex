...
However, component must be created with coordination in mind such that they expose possible coordination points.
...
To put it in a nutshell, some approaches allow changing coordination without touching the components while in others this is not possible.
This is exactly the difference between non-intrusive and intrusive coordination specification.
